...
- SETSAR contract address: `0x0000000000000000000000000000000001000008`.

- RENBTC contract address:  `0x0000000000000000000000000000000001000121`.

- LP_DRAM_DNAR contract address: `0x0000000000000000000000010000000100000000`.
- LP_SETUSD_DNAR contract address: `0x0000000000000000000000010000000300000000`.
- LP_SETEUR_DNAR contract address: `0x0000000000000000000000010000000400000000`
- LP_SETGBP_DNAR contract address: `0x0000000000000000000000010000000500000000`.
- LP_SETCHF_DNAR contract address: `0x0000000000000000000000010000000600000000`.
- LP_SETSAR_DNAR contract address: `0x0000000000000000000000010000000700000000`.
- LP_RENBTC_DNAR contract address: `0x0000000000000000000000010000012100000000`.
...
- LP_SETCHF_SETR contract address: `0x0000000000000000000000010000000600000002`.
- LP_SETSAR_SETR contract address: `0x0000000000000000000000010000000700000002`.
- LP_RENBTC_SETR contract address: `0x0000000000000000000000010000012100000002`.

- LP_DRAM_SETUSD contract address: `0x0000000000000000000000010000000100000003`.
- LP_SETEUR_SETUSD contract address: `0x0000000000000000000000010000000400000003`
- LP_SETGBP_SETUSD contract address: `0x0000000000000000000000010000000500000003`.
- LP_SETCHF_SETUSD contract address: `0x0000000000000000000000010000000600000003`.
- LP_SETSAR_SETUSD contract address: `0x0000000000000000000000010000000700000003`.
- LP_RENBTC_SETUSD contract address: `0x0000000000000000000000010000012100000003`.
...
These contracts will make Setheum's DeFi primitives (SetMint, SERP, SettPay) available in SetheumEVM (SEVM).
