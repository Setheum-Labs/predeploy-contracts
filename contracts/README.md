...
- SETR contract address: `0x0000000000000000000000000000000001000003`.
- SETUSD contract address: `0x0000000000000000000000000000000001000004`.
...
- LP_SERP_SETUSD contract address: `0x0000000000000000000000010000000100000004`.
- LP_DNAR_SETUSD contract address: `0x0000000000000000000000010000000200000004`
- LP_SETR_SETUSD contract address: `0x0000000000000000000000010000000300000004`
- LP_RENBTC_SETUSD contract address: `0x0000000000000000000000010000012100000004`.
...
These contracts will make Setheum's DeFi primitives (SetMint, SERP, SetPay) available in SetheumEVM (SEVM).
